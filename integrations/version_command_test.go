...
var _ = Describe("version command", func() {
	...
	It("reports the version that's injected at build-time", func() {
		...
		commandPathWithVersion, err := Build("github.com/greenplum-db/gpupgrade/cli", "-ldflags", "-X github.com/greenplum-db/gpupgrade/cli/commanders.GpdbVersion="+fake_version)
